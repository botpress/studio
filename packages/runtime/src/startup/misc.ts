...
export const loadEnvVars = () => {
  ...
  process.DISABLE_GLOBAL_SANDBOX = <boolean>yn(process.runtime_env.DISABLE_GLOBAL_SANDBOX)
  process.DISABLE_BOT_SANDBOX = <boolean>yn(process.runtime_env.DISABLE_BOT_SANDBOX)
  process.DISABLE_TRANSITION_SANDBOX = <boolean>yn(process.runtime_env.DISABLE_TRANSITION_SANDBOX)
  process.DISABLE_CONTENT_SANDBOX = <boolean>yn(process.runtime_env.DISABLE_CONTENT_SANDBOX)
  process.IS_LICENSED = true
  process.ASSERT_LICENSED = () => {}
  process.BPFS_STORAGE = process.runtime_env.BPFS_STORAGE || 'disk'
  process.CLUSTER_ENABLED = <boolean>yn(process.runtime_env.CLUSTER_ENABLED)
