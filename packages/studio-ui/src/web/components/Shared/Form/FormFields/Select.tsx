  ...
  return (
    <Fragment>
      <Dropdown
        ...
        placeholder={field.placeholder && lang.tr(field.placeholder as string)}
        items={options?.map((option) => ({ ...option, label: lang.tr(option.label) })) || []}
        defaultItem={currentOption && { ...currentOption, label: lang.tr(currentOption.label) }}
